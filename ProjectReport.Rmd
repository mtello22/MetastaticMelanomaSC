...
sc_metadata <- fread("Data/GSE72056_melanoma_single_cell_revised_v2.tsv", 
...
# Load donor metadata
sample_metadata <- fread("Data/sample_metadata_simplified.tsv")
...
scexp <- fread("Data/GSE72056_melanoma_single_cell_revised_v2.tsv", header = TRUE)
...
validation_genes <- fread("Data/GSE77940_pre_post_melanoma.tsv", select = 1, col.names = "ENSGN")
...
fwrite(scexp_train, 
       "Data/train_ft_sd_topvar.tsv", append = FALSE, quote = FALSE, sep = '\t', 
...
fwrite(scexp_test, 
       "Data/test_ft_sd_topvar.tsv", append = FALSE, quote = FALSE, sep = '\t', 
       row.names = FALSE, col.names = TRUE)
...
validation_data <- fread("Data/GSE77940_pre_post_melanoma.tsv")
...
# Add target variable
validation_metadata <- fread("Data/bulk_metadata_encoded.txt", select = c(1,3))
...
# Write data
fwrite(validation_data, "Data/bulk_validation_sd_encoded.tsv", append = FALSE, quote = FALSE, sep = '\t', row.names = FALSE, col.names = TRUE)
